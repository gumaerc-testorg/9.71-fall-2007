...
How to present a paper ([PDF]({{< baseurl >}}/resources/presentingpaper))

Instructions for Paper Critique
-------------------------------

How to critically evaluate fMRI studies ([PDF]({{< baseurl >}}/resources/crtqufmripapr))

Instructions for Term Paper
---------------------------

How to write a review article and propose a novel experiment ([PDF]({{< baseurl >}}/resources/trmpaproptions))

Instructions for Final Project
------------------------------

How to make presentations on experiment proposals and literature reviews ([PDF]({{< baseurl >}}/resources/finalprojects))

Student Work
------------

([PDF]({{< baseurl >}}/resources/difrntalactivton)) (Courtesy of MIT student. Used with permission.)
...
Schiltz, C., and B. Rossion. "Faces are Represented Holistically in the Human Occipito-Temporal Cortex." _Neuroimage_ 32 (2006): 1385-1394.
...
Fang, F., and S. He. "Cortical Responses to Invisible Objects in the Human Dorsal and Ventral Pathways." _Nat Neurosci_ 8, no. 10 (2005): 1380-5.
